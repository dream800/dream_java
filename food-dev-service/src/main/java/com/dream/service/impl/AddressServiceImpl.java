...
import com.dream.mapper.UserAddressMapper;
import com.dream.pojo.Carousel;
import com.dream.pojo.UserAddress;
import com.dream.pojo.bo.AddressBO;
...
public class AddressServiceImpl implements AddressService {
    ...
    public List<UserAddress> queryAll(String userId) {
        ...
        return userAddressMapper.selectAddressByUid(userId);
    }
...
//        // 2. 保存地址到数据库
    ...
    public UserAddress queryUserAddres(String userId, String addressId) {
        return userAddressMapper.selectUserAddress(addressId, userId);
    }
}
